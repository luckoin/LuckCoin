#############################################################################
# Makefile for building: LuckCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ?? 24 16:15:05 2016
# Project:  LuckCoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=- USE_QRCODE=1 -o Makefile LuckCoin-qt.pro
#############################################################################
...
Makefile: LuckCoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile LuckCoin-qt.pro
