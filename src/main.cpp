...
int64 nChainStartTime = 1474694952;
...
static int FINAL_POW_HEIGHT = 5000000;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LuckCoin
    bool fStrictPayToScriptHash = true; // Always active in LuckCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "huobi here makethsi new 2016/09/24, CHECK THIS!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x84cfe7fe90f92a02d39f47f9274010f26360a4808c206afffdc20d670874494d"));
